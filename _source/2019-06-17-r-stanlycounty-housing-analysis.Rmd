...
```{r, fig.width=12}
download.file(url = "https://docs.google.com/uc?export=download&id=1QGN6cZmRnYokMWX-7ItR2J-aFiQytaD7", destfile = "stanly_house_data_sample_wcoords.csv", mode="wb")
house.data.highValued <- read.csv("stanly_house_data_dist548_with_coords.csv.csv")
MAX_LAT <- 35.25
MAX_LONG <- -80.10
...
download.file(url = "https://docs.google.com/uc?export=download&id=1oFBXyLe4pKytDgYFPSbG3J1v9MtqW5mu", destfile = "stanly_house_data_sample_wcoords.csv", mode="wb")
