...
set.seed(2018)
# Ignore TMV (prediction) and factor categories
...
```{r, fig.width=12}
download.file(url = "https://docs.google.com/uc?export=download&id=1QGN6cZmRnYokMWX-7ItR2J-aFiQytaD7", destfile = "dist548_wcoords.csv", mode="wb")
house.data.highValued <- read.csv("dist548_wcoords.csv")
MAX_LAT <- 35.25
MAX_LONG <- -80.10
...
download.file(url = "https://docs.google.com/uc?export=download&id=1oFBXyLe4pKytDgYFPSbG3J1v9MtqW5mu", destfile = "sample_data_wcoords.csv", mode="wb")
house.data.ips <- read.csv('sample_data_wcoords.csv', header=TRUE)
