...
```{r, fig.width=12}
download.file(url = "https://docs.google.com/uc?export=download&id=1QGN6cZmRnYokMWX-7ItR2J-aFiQytaD7", destfile = "stanly_house_data_dist548_with_coords.csv", mode="wb")
